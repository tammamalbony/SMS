                                ...
                                @foreach ($yearClassSubject->partsInputs as $part)
                                    @if ($part->term_id == null || $part->term_id == $term->id)
                                        ...
                                        <div class="col-6 order-4 card shadow-sm card-cutom">
                                            <h5>{{ $part->name }} :</h5>
                                            @if ($examResult)
                                                @php  $total += $examResult->failing_grade @endphp
                                                <form action="{{ route('exam_results.update', $examResult->id) }}"
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-group mb-0 mt-1 custom-switches-stacked">
                                                            <label
                                                                class="custom-switch pl-0 d-flex align-items-center mb-0">
                                                                <input type="hidden"
                                                                    id="islocked_hidden_{{ $examResult->id }}"
                                                                    name="islocked" value="0">
                                                ...
                                                @endif
                                            @else
                                                @php  $total += $part->max_per_cent @endphp
                                                ...
                                                <form method="POST" action="{{ route('exam_results.store') }}"
                                                    ...
                                                    <input type="hidden" name="term_id" value="{{ $term->id }}">
                                                    <input type="hidden" id="max_grade_{{ $part->id }}"
                                                        name="max_grade" value="{{ $max }}" required>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="value_{{ $part->id }}"
                                                            name="value" step="0.01" class="form-control" required>
                                                        <div class="invalid-feedback"
                                                            id="value-error_{{ $part->id }}" style="display:none;">
                                                            {{ __('Value must be between 0 and') }} {{ $max }}
                                                        </div>
                                                    </div>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="form-group mb-0 mt-1 custom-switches-stacked">
