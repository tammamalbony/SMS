...
function getSubjectKey1($subjectName) {
    $subjects = [
        'M1' => 'التربية الدينية',
        'M2' => 'المهارات الشفوية',
        'M3' => 'المهارات الكتابية',
        'M4' => 'اللغة الأجنبية',
        'M5' => 'الرياضيات',
        'M6' => 'الدراسات الإجتماعية',
        'M7' => 'العلوم و التربية الصحية',
        'M8' => 'التربية الموسيقية',
        'M9' => 'التربية الفنية البصرية والجمالية',
        'M10' => 'التربية البدنية و الرياضة',
        'M11' => 'التربية الزراعية',
        'M12' => 'المشروع',
        'M13' => 'السلوك',
        'M14' => 'النشاط المدرسي و الطلائع',
    ];

    $subjectKey = array_search($subjectName, $subjects);
    return $subjectKey !== false ? $subjectKey : null;
}