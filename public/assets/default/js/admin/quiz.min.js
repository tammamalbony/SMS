...
(function ($) {
  ...
  $('body').on('click', '#add_multiple_true_question', function (e) {
    e.preventDefault();
    var quizId = $(this).attr('data-quiz-id');
    var multipleQuestionModal = $('.multipleQuestionTrueModal' + quizId);
    var clone = multipleQuestionModal.clone();
    var id = 'correctAnswerTrueSwitch' + randomString();
    clone.find('label.js-switch-true').attr('for', id);
    clone.find('input.js-switch-true').attr('id', id);
    var random_id = randomString();
    clone.find('.panel-file-manager').attr('data-input', random_id);
    clone.find('.main-answer-true-row').removeClass('main-answer-true-row').addClass('main-answer-true-box');
    var copyHtml = clone.prop('innerHTML');
    copyHtml = copyHtml.replaceAll('record', random_id);
    copyHtml = copyHtml.replaceAll('ans_tmp', 'ans_temp');
    clone.html(copyHtml);
  ...
  $('body').on('click', '.add-answer-true-btn', function (e) {
    e.preventDefault();
    var mainRow = $('.add-answer-true-container .main-answer-true-box');
    var copy = mainRow.clone();
    copy.removeClass('main-answer-true-box');
    copy.find('.answer-remove').removeClass('d-none');
    var id = 'correctAnswertrueSwitch' + randomString();
    copy.find('label.js-switch-true').attr('for', id);
    copy.find('input.js-switch-true').attr('id', id);
    copy.find('input[type="checkbox"]').prop('checked', false);
    var copyHtml = copy.prop('innerHTML');
    var nameId = randomString();
    copyHtml = copyHtml.replaceAll('ans_temp', nameId);
  ...
  $('body').on('change', '.js-switch-true', function () {
    var $this = $(this);
    if (this.checked) {
      $this.prop('checked', true);
    }
